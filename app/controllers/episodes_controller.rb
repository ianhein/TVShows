class EpisodesController < ApplicationController
  ...
  def index
    ...
    #Filtro para buscar por Titulo 5.2
    @episodes = Episode.where(:title => params[:title]) unless params[:title].blank?
   # @episodes = Episode.where(:season_id => params[:season_id]) unless params[:season_id]
end
